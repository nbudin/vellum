class Ability
  ...
  def initialize(person, project_invitation)
    can [:read, :consume], ProjectInvitation
    ...
    if person
      ...
      if person.admin?
        ...
        can(:resend, ProjectInvitation, :project_id => admin_project_ids)
